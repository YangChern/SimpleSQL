...
/**
 * Created by YangChern on 2016/12/8.
 */
...
//        testCreateWrite();
    ...
    private static void testCreateWrite() {
        try {
            ...
            RandomAccessFile raf = new RandomAccessFile(file, "rwb");
